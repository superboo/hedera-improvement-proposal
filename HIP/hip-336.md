...
the end result would be that *userC* would retain the allowance to NFT *T* serial *S* while *userB* would have their allowance for NFT *T* serial *S* removed.
...
the end result would be that *userC* would now have an allowance to NFT *T* serials *R* and *S* while *userB* would have their allowance for NFT *T* serial *R* removed.
